...
"""
edx_event_bus_kafka documentation build configuration file.
...
VERSION = get_distribution_version('edx-event-bus-kafka')
...
#
html_theme_options = {
 "repository_url": "https://github.com/openedx/event-bus-kafka",
...
#
# html_title = 'edx_event_bus_kafka v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Kafka implementation for Open edX event bus.',
     'Miscellaneous'),
]
